...
export class DavesDataService {
    ...
    constructor() { 
        ...
        this.jokes = [
            ...
            {
            id: 30,
            joke: "Someone once tried to tell Chuck Norris that roundhouse kicks aren't the best way to kick someone. This has been recorded by historians as the worst mistake anyone has ever made.",
            categories: [ ]
            },
            {
            id: 31,
            ...
            {
            id: 36,
            joke: "Chuck Norris originally appeared in the &quot;Street Fighter II&quot; video game, but was removed by Beta Testers because every button caused him to do a roundhouse kick. When asked about this glitch, Norris replied &quot;That's no glitch.&quot;",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 41,
            joke: "Chuck Norris doesn't wash his clothes. He disembowels them.",
            categories: [ ]
            },
            {
            id: 42,
            ...
            {
            id: 44,
            joke: "Chuck Norris is the only man to ever defeat a brick wall in a game of tennis.",
            categories: [ ]
            },
            {
            id: 45,
            joke: "What was going through the minds of all of Chuck Norris' victims before they died? His shoe.",
            categories: [ ]
            },
            {
            id: 47,
            ...
            {
            id: 48,
            joke: "Chuck Norris can win a game of Connect Four in only three moves.",
            categories: [ ]
            },
            {
            id: 49,
            joke: "CNN was originally created as the &quot;Chuck Norris Network&quot; to update Americans with on-the-spot ass kicking in real-time.",
            categories: [ ]
            },
            {
            id: 50,
            ...
            {
            id: 53,
            joke: "Chuck Norris drives an ice cream truck covered in human skulls.",
            categories: [ ]
            },
            {
            id: 55,
            ...
            {
            id: 56,
            joke: "The Great Wall of China was originally created to keep Chuck Norris out. It failed miserably.",
            categories: [ ]
            },
            {
            id: 57,
            joke: "Chuck Norris is ten feet tall, weighs two-tons, breathes fire, and could eat a hammer and take a shotgun blast standing.",
            categories: [ ]
            },
            {
            id: 58,
            ...
            {
            id: 60,
            joke: "When Chuck Norris calls 1-900 numbers, he doesn't get charged. He holds up the phone and money falls out.",
            categories: [ ]
            },
            {
            id: 61,
            ...
            {
            id: 64,
            joke: "There are no races, only countries of people Chuck Norris has beaten to different shades of black and blue.",
            categories: [ ]
            },
            {
            id: 65,
            ...
            {
            id: 67,
            joke: "A Chuck Norris-delivered Roundhouse Kick is the preferred method of execution in 16 states.",
            categories: [ ]
            },
            {
            id: 68,
            ...
            {
            id: 80,
            joke: "Newton's Third Law is wrong: Although it states that for each action, there is an equal and opposite reaction, there is no force equal in reaction to a Chuck Norris roundhouse kick.",
            categories: [ ]
            },
            {
            id: 81,
            ...
            {
            id: 83,
            joke: "While urinating, Chuck Norris is easily capable of welding titanium.",
            categories: [ ]
            },
            {
            id: 84,
            joke: "When Chuck Norris talks, everybody listens. And dies.",
            categories: [ ]
            },
            {
            id: 85,
            joke: "When Steven Seagal kills a ninja, he only takes its hide. When Chuck Norris kills a ninja, he uses every part.",
            categories: [ ]
            },
            {
            id: 86,
            ...
            {
            id: 87,
            joke: "Contrary to popular belief, there is indeed enough Chuck Norris to go around.",
            categories: [ ]
            },
            {
            id: 88,
            ...
            {
            id: 91,
            joke: "When taking the SAT, write &quot;Chuck Norris&quot; for every answer. You will score over 8000.",
            categories: [ ]
            },
            {
            id: 92,
            joke: "Chuck Norris invented black. In fact, he invented the entire spectrum of visible light. Except pink. Tom Cruise invented pink.",
            categories: [ ]
            },
            {
            id: 93,
            ...
            {
            id: 94,
            joke: "Chuck Norris has the greatest Poker-Face of all time. He won the 1983 World Series of Poker, despite holding only a Joker, a Get out of Jail Free Monopoly card, a 2 of clubs, 7 of spades and a green #4 card from the game UNO.",
            categories: [ ]
            },
            {
            id: 95,
            joke: "On his birthday, Chuck Norris randomly selects one lucky child to be thrown into the sun.",
            categories: [ ]
            },
            {
            id: 96,
            ...
            {
            id: 97,
            joke: "Chuck Norris doesn't throw up if he drinks too much. Chuck Norris throws down!",
            categories: [ ]
            },
            {
            id: 98,
            joke: "In the beginning there was nothing...then Chuck Norris Roundhouse kicked that nothing in the face and said &quot;Get a job&quot;. That is the story of the universe.",
            categories: [ ]
            },
            {
            id: 99,
            ...
            {
            id: 102,
            joke: "Chuck Norris ordered a Big Mac at Burger King, and got one.",
            categories: [ ]
            },
            {
            id: 103,
            ...
            {
            id: 105,
            joke: "Chuck Norris can drink an entire gallon of milk in thirty-seven seconds.",
            categories: [ ]
            },
            {
            id: 106,
            joke: "Little known medical fact: Chuck Norris invented the Caesarean section when he roundhouse-kicked his way out of his mother's womb.",
            categories: [ ]
            },
            {
            id: 107,
            ...
            {
            id: 116,
            joke: "Chuck Norris once ate an entire bottle of sleeping pills. They made him blink.",
            categories: [ ]
            },
            {
            id: 117,
            joke: "James Cameron wanted Chuck Norris to play the Terminator. However, upon reflection, he realized that would have turned his movie into a documentary, so he went with Arnold Schwarzenegger.",
            categories: [ ]
            },
            {
            id: 118,
            ...
            {
            id: 119,
            joke: "Thousands of years ago Chuck Norris came across a bear. It was so terrified that it fled north into the arctic. It was also so terrified that all of its decendents now have white hair.",
            categories: [ ]
            },
            {
            id: 120,
            joke: "Chuck Norris played Russian Roulette with a fully loaded gun and won.",
            categories: [ ]
            },
            {
            id: 121,
            joke: "It takes 14 puppeteers to make Chuck Norris smile, but only 2 to make him destroy an orphanage.",
            categories: [ ]
            },
            {
            id: 122,
            joke: "Chuck Norris is responsible for China's over-population. He hosted a Karate tournament in Beijing and all women within 1,000 miles became pregnant instantly.",
            categories: [ ]
            },
            {
            id: 123,
            ...
            {
            id: 124,
            joke: "Chuck Norris once worked as a weatherman for the San Diego evening news. Every night he would make the same forecast: Partly cloudy with a 75% chance of Pain.",
            categories: [ ]
            },
            {
            id: 125,
            joke: "Simply by pulling on both ends, Chuck Norris can stretch diamonds back into coal.",
            categories: [ ]
            },
            {
            id: 126,
            joke: "When Chuck Norris does a pushup, he isn't lifting himself up, he's pushing the Earth down.",
            categories: [ ]
            },
            {
            id: 127,
            ...
            {
            id: 128,
            joke: "A high tide means Chuck Norris is flying over your coast. The tide is caused by God pissing his pants.",
            categories: [ ]
            },
            {
            id: 129,
            joke: "Chuck Norris keeps his friends close and his enemies closer. Close enough to drop them with one round house kick to the face.",
            categories: [ ]
            },
            {
            id: 130,
            joke: "There is in fact an 'I' in Norris, but there is no 'team'. Not even close.",
            categories: [ ]
            },
            {
            id: 131,
            joke: "Scotty in Star Trek often says &quot;Ye cannae change the laws of physics.&quot; This is untrue. Chuck Norris can change the laws of physics. With his fists.",
            categories: [ ]
            },
            {
            id: 132,
            joke: "An anagram for Walker Texas Ranger is KARATE WRANGLER SEX. I don't know what that is, but it sounds AWESOME.",
            categories: [ ]
            },
            {
            id: 133,
            ...
            {
            id: 135,
            joke: "Chuck Norris roundhouse kicks don't really kill people. They wipe out their entire existence from the space-time continuum.",
            categories: [ ]
            },
            {
            id: 136,
            ...
            {
            id: 141,
            joke: "The original draft of The Lord of the Rings featured Chuck Norris instead of Frodo Baggins. It was only 5 pages long, as Chuck roundhouse-kicked Sauron's ass halfway through the first chapter.",
            categories: [ ]
            },
            {
            id: 142,
            ...
            {
            id: 143,
            joke: "Chuck Norris eats beef jerky and craps gunpowder. Then, he uses that gunpowder to make a bullet, which he uses to kill a cow and make more beef jerky. Some people refer to this as the &quot;Circle of Life.&quot;",
            categories: [ ]
            },
            {
            id: 144,
            joke: "If, by some incredible space-time paradox, Chuck Norris would ever fight himself, he'd win. Period.",
            categories: [ ]
            },
            {
            id: 145,
            ...
            {
            id: 146,
            joke: "The crossing lights in Chuck Norris's home town say &quot;Die slowly&quot; and &quot;die quickly&quot;. They each have a picture of Chuck Norris punching or kicking a pedestrian.",
            categories: [ ]
            },
            {
            id: 147,
            joke: "Science Fact: Roundhouse kicks are comprised primarily of an element called Chucktanium.",
            categories: [ ]
            },
            {
            id: 149,
            ...
            {
            id: 154,
            joke: "Movie trivia: The movie &quot;Invasion U.S.A.&quot; is, in fact, a documentary.",
            categories: [ ]
            },
            {
            id: 155,
            ...
            {
            id: 158,
            joke: "It's widely believed that Jesus was Chuck Norris' stunt double for crucifixion due to the fact that it is impossible for nails to pierce Chuck Norris' skin.",
            categories: [ ]
            },
            {
            id: 159,
            joke: "Chuck Norris did in fact, build Rome in a day.",
            categories: [ ]
            },
            {
            id: 160,
            joke: "Along with his black belt, Chuck Norris often chooses to wear brown shoes. No one has DARED call him on it. Ever.",
            categories: [ ]
            },
            {
            id: 162,
            ...
            {
            id: 163,
            joke: "Ninjas want to grow up to be just like Chuck Norris. But usually they grow up just to be killed by Chuck Norris.",
            categories: [ ]
            },
            {
            id: 164,
            ...
            {
            id: 165,
            joke: "The last thing you hear before Chuck Norris gives you a roundhouse kick? No one knows because dead men tell no tales.",
            categories: [ ]
            },
            {
            id: 166,
            ...
            {
            id: 167,
            joke: "As a teen, Chuck Norris had sex with every nun in a convent tucked away in the hills of Tuscany. Nine months later the nuns gave birth to the 1972 Miami Dolphins, the only undefeated and untied team in professional football history.",
            categories: [ ]
            },
            {
            id: 168,
            joke: "Chuck Norris is the only person in the world that can actually email a roundhouse kick.",
            categories: [ ]
            },
            {
            id: 169,
            joke: "Chuck Norris won super bowls VII and VIII singlehandedly before unexpectedly retiring to pursue a career in ass-kicking.",
            categories: [ ]
            },
            {
            id: 170,
            joke: "Wo hu cang long. The translation from Mandarin Chinese reads: &quot;Crouching Chuck, Hidden Norris&quot;",
            categories: [ ]
            },
            {
            id: 171,
            ...
            {
            id: 173,
            joke: "'Icy-Hot' is too weak for Chuck Norris. After a workout, Chuck Norris rubs his muscles down with liquid-hot MAGMA.",
            categories: [ ]
            },
            {
            id: 174,
            joke: "Chuck Norris cannot love, he can only not kill.",
            categories: [ ]
            },
            {
            id: 175,
            ...
            {
            id: 177,
            joke: "Chuck Norris once pulled out a single hair from his beard and skewered three men through the heart with it.",
            categories: [ ]
            },
            {
            id: 178,
            ...
            {
            id: 180,
            joke: "When J. Robert Oppenheimer said &quot;I am become death, the destroyer Of worlds&quot;, He was not referring to the atomic bomb. He was referring to the Chuck Norris halloween costume he was wearing.",
            categories: [ ]
            },
            {
            id: 181,
            ...
            {
            id: 182,
            joke: "In a recent survey it was discovered the 94% of American women lost their virginity to Chuck Norris. The other 6% were incredibly fat or ugly.",
            categories: [ ]
            },
            {
            id: 183,
            joke: "Chuck Norris invented a language that incorporates karate and roundhouse kicks. So next time Chuck Norris is kicking your ass, don?t be offended or hurt, he may be just trying to tell you he likes your hat.",
            categories: [ ]
            },
            {
            id: 184,
            joke: "If at first you don't succeed, you're not Chuck Norris.",
            categories: [ ]
            },
            {
            id: 185,
            ...
            {
            id: 186,
            joke: "Fear is not the only emotion Chuck Norris can smell. He can also detect hope, as in &quot;I hope I don't get a roundhouse kick from Chuck Norris.&quot;",
            categories: [ ]
            },
            {
            id: 187,
            joke: "# Chuck Norris's show is called Walker: Texas Ranger, because Chuck Norris doesn't run.",
            categories: [ ]
            },
            {
            id: 188,
            ...
            {
            id: 189,
            joke: "Behind every successful man, there is a woman. Behind every dead man, there is Chuck Norris.",
            categories: [ ]
            },
            {
            id: 190,
            ...
            {
            id: 194,
            joke: "The US did not boycott the 1980 Summer Olympics in Moscow due to political reasons: Chuck Norris killed the entire US team with a single round-house kick during TaeKwonDo practice.",
            categories: [ ]
            },
            {
            id: 195,
            ...
            {
            id: 196,
            joke: "The Bible was originally titled &quot;Chuck Norris and Friends&quot;",
            categories: [ ]
            },
            {
            id: 197,
            joke: "Chuck Norris began selling the Total Gym as an ill-fated attempt to make his day-to-day opponents less laughably pathetic.",
            categories: [ ]
            },
            {
            id: 198,
            ...
            {
            id: 199,
            joke: "When Chuck Norris says &quot;More cowbell&quot;, he MEANS it.",
            categories: [ ]
            },
            {
            id: 200,
            joke: "On the set of Walker Texas Ranger Chuck Norris brought a dying lamb back to life by nuzzling it with his beard. As the onlookers gathered, the lamb sprang to life. Chuck Norris then roundhouse kicked it, killing it instantly. This was just to prove that the good Chuck givet",
            categories: [ ]
            },
            {
            id: 201,
            ...
            {
            id: 202,
            joke: "Google won't search for Chuck Norris because it knows you don't find Chuck Norris, he finds you.",
            categories: [ ]
            },
            {
            id: 203,
            ...
            {
            id: 205,
            joke: "It is scientifically impossible for Chuck Norris to have had a mortal father. The most popular theory is that he went back in time and fathered himself.",
            categories: [ ]
            },
            {
            id: 206,
            ...
            {
            id: 208,
            joke: "Chuck Norris shot the sheriff, but he round house kicked the deputy.",
            categories: [ ]
            },
            {
            id: 209,
            joke: "That's not Chuck Norris doing push-ups -- that's Chuck Norris moving the Earth away from the path of a deadly asteroid.",
            categories: [ ]
            },
            {
            id: 210,
            joke: "Chuck Norris can judge a book by its cover.",
            categories: [ ]
            },
            {
            id: 211,
            ...
            {
            id: 212,
            joke: "Chuck Norris does not play the lottery. It doesn't have nearly enough balls.",
            categories: [ ]
            },
            {
            id: 213,
            ...
            {
            id: 217,
            joke: "Crime does not pay - unless you are an undertaker following Walker, Texas Ranger, on a routine patrol.",
            categories: [ ]
            },
            {
            id: 218,
            joke: "Chuck Norris invented the internet? just so he had a place to store his porn.",
            categories: [ ]
            },
            {
            id: 219,
            ...
            {
            id: 221,
            joke: "Chuck Norris is the only person to ever win a staring contest against Ray Charles and Stevie Wonder.",
            categories: [ ]
            },
            {
            id: 222,
            joke: "Industrial logging isn't the cause of deforestation. Chuck Norris needs toothpicks.",
            categories: [ ]
            },
            {
            id: 223,
            joke: "Chuck Norris smells what the Rock is cooking... because the Rock is Chuck Norris' personal chef.",
            categories: [ ]
            },
            {
            id: 224,
            joke: "When Chuck Norris plays Oregon Trail, his family does not die from cholera or dysentery, but rather, roundhouse kicks to the face. He also requires no wagon, since he carries the oxen, axels, and buffalo meat on his back. He always makes it to Oregon before you.",
            categories: [ ]
            },
            {
            id: 225,
            ...
            {
            id: 234,
            joke: "Chuck Norris kills anyone that asks: &quot;Do you want fries with that?&quot;. Because by now everyone should know that Chuck doesn't want fries with anything. Ever.",
            categories: [ ]
            },
            {
            id: 235,
            joke: "Chuck Norris once kicked a horse in the chin. Its descendants are known today as Giraffes.",
            categories: [ ]
            },
            {
            id: 236,
            joke: "Sticks and stones may break your bones, but a Chuck Norris glare will liquefy your kidneys.",
            categories: [ ]
            },
            {
            id: 237,
            ...
            {
            id: 238,
            joke: "Chuck Norris once went skydiving, but promised never to do it again. One Grand Canyon is enough.",
            categories: [ ]
            },
            {
            id: 239,
            joke: "Chuck Norris's version of a &quot;chocolate milkshake&quot; is a raw porterhouse wrapped around ten Hershey bars, and doused in diesel fuel.",
            categories: [ ]
            },
            {
            id: 240,
            ...
            {
            id: 243,
            joke: "Contrary to popular belief, the Titanic didn't hit an iceberg. The ship was off course and ran into Chuck Norris while he was doing the backstroke across the Atlantic.",
            categories: [ ]
            },
            {
            id: 244,
            joke: "Chuck Norris got his drivers license at the age of 16. Seconds.",
            categories: [ ]
            },
            {
            id: 245,
            ...
            {
            id: 246,
            joke: "Chuck Norris? sperm is so badass, he had sex with Nicole Kidman, and 7 months later she prematurely gave birth to a Ford Excursion.",
            categories: [ ]
            },
            {
            id: 247,
            ...
            {
            id: 248,
            joke: "Chuck Norris once shat blood - the blood of 11,940 natives he had killed and eaten.",
            categories: [ ]
            },
            {
            id: 249,
            ...
            {
            id: 251,
            joke: "Kryptonite has been found to contain trace elements of Chuck Norris roundhouse kicks to the face. This is why it is so deadly to Superman.",
            categories: [ ]
            },
            {
            id: 252,
            joke: "Saddam Hussein was not found hiding in a &quot;hole.&quot; Saddam was roundhouse-kicked in the head by Chuck Norris in Kansas, which sent him through the earth, stopping just short of the surface of Iraq.",
            categories: [ ]
            },
            {
            id: 253,
            ...
            {
            id: 254,
            joke: "Chuck Norris doesn't look both ways before he crosses the street... he just roundhouses any cars that get too close.",
            categories: [ ]
            },
            {
            id: 255,
            ...
            {
            id: 258,
            joke: "The phrase 'break a leg' was originally coined by Chuck Norris's co-stars in Walker, Texas Ranger as a good luck charm, indicating that a broken leg might be the worst extent of their injuries. This never proved to be the case.",
            categories: [ ]
            },
            {
            id: 259,
            ...
            {
            id: 260,
            joke: "If you rearrange the letters in &quot;Chuck Norris&quot;, they also spell &quot;Crush Rock In&quot;. The words &quot;with his fists&quot; are understood.",
            categories: [ ]
            },
            {
            id: 261,
            ...
            {
            id: 262,
            joke: "Chuck Norris used to play baseball. When Babe Ruth was hailed as the better player, Chuck Norris killed him with a baseball bat to the throat. Lou Gehrig got off easy.",
            categories: [ ]
            },
            {
            id: 263,
            ...
            {
            id: 264,
            joke: "Guantuanamo Bay, Cuba, is the military code-word for &quot;Chuck Norris' basement&quot;.",
            categories: [ ]
            },
            {
            id: 265,
            joke: "The phrase 'balls to the wall' was originally conceived to describe Chuck Norris entering any building smaller than an aircraft hangar.",
            categories: [ ]
            },
            {
            id: 266,
            joke: "Chuck Norris? roundhouse kick is so powerful, it can be seen from outer space by the naked eye.",
            categories: [ ]
            },
            {
            id: 267,
            ...
            {
            id: 269,
            joke: "The best-laid plans of mice and men often go awry. Even the worst-laid plans of Chuck Norris come off without a hitch.",
            categories: [ ]
            },
            {
            id: 270,
            ...
            {
            id: 271,
            joke: "Staring at Chuck Norris for extended periods of time without proper eye protection will cause blindess, and possibly foot sized brusies on the face.",
            categories: [ ]
            },
            {
            id: 272,
            joke: "Chuck Norris can taste lies.",
            categories: [ ]
            },
            {
            id: 273,
            joke: "Chuck Norris does not kick ass and take names. In fact, Chuck Norris kicks ass and assigns the corpse a number. It is currently recorded to be in the billions.",
            categories: [ ]
            },
            {
            id: 274,
            joke: "One time, Chuck Norris accidentally stubbed his toe. It destroyed the entire state of Ohio.",
            categories: [ ]
            },
            {
            id: 275,
            ...
            {
            id: 279,
            joke: "Chuck Norris does, in fact, live in a round house.",
            categories: [ ]
            },
            {
            id: 280,
            joke: "When Chuck Norris works out on the Total Gym, the Total Gym feels like it's been raped.",
            categories: [ ]
            },
            {
            id: 281,
            joke: "4 out of 5 doctors fail to recommend Chuck Norris as a solution to most problems. Also, 80% of doctors die unexplained, needlessly brutal deaths.",
            categories: [ ]
            },
            {
            id: 282,
            ...
            {
            id: 283,
            joke: "The only sure things are Death and Taxes and when Chuck Norris goes to work for the IRS, they'll be the same thing.",
            categories: [ ]
            },
            {
            id: 284,
            ...
            {
            id: 285,
            joke: "With the rising cost of gasoline, Chuck Norris is beginning to worry about his drinking habit.",
            categories: [ ]
            },
            {
            id: 286,
            joke: "The square root of Chuck Norris is pain. Do not try to square Chuck Norris, the result is death.",
            categories: [ ]
            },
            {
            id: 287,
            joke: "Chuck Norris' testicles do not produce sperm. They produce tiny white ninjas that recognize only one mission: seek and destroy.",
            categories: [ ]
            },
            {
            id: 288,
            joke: "To be or not to be? That is the question. The answer? Chuck Norris.",
            categories: [ ]
            },
            {
            id: 289,
            joke: "Chuck Norris has never been in a fight, ever. Do you call one roundhouse kick to the face a fight?",
            categories: [ ]
            },
            {
            id: 290,
            ...
            {
            id: 291,
            joke: "Chuck Norris never wet his bed as a child. The bed wet itself out of fear.",
            categories: [ ]
            },
            {
            id: 292,
            ...
            {
            id: 294,
            joke: "Jean-Claude Van Damme once kicked Chuck Norris' ass. He was then awakened from his dream by a roundhouse kick to the face.",
            categories: [ ]
            },
            {
            id: 295,
            ...
            {
            id: 299,
            joke: "Jack Bauer tried to use his detailed knowledge of torture techniques, but to no avail: Chuck Norris thrives on pain. Chuck Norris then ripped off Jack Bauer's arm and beat him to death with it. Game, set, match.",
            categories: [ ]
            },
            {
            id: 300,
            ...
            {
            id: 301,
            joke: "The First Law of Thermodynamics states that energy can neither be created nor destroyed... unless it meets Chuck Norris.",
            categories: [ ]
            },
            {
            id: 302,
            ...
            {
            id: 304,
            joke: "It is said that looking into Chuck Norris' eyes will reveal your future. Unfortunately, everybody's future is always the same: death by a roundhouse-kick to the face.",
            categories: [ ]
            },
            {
            id: 305,
            ...
            {
            id: 306,
            joke: "Scientifically speaking, it is impossible to charge Chuck Norris with &quot;obstruction of justice.&quot; This is because even Chuck Norris cannot be in two places at the same time.",
            categories: [ ]
            },
            {
            id: 307,
            ...
            {
            id: 308,
            joke: "When you say &quot;no one's perfect&quot;, Chuck Norris takes this as a personal insult.",
            categories: [ ]
            },
            {
            id: 309,
            joke: "Chuck Norris can win a game of Trivial Pursuit with one roll of the dice, and without answering a single question... just a nod of the head, and a stroke of the beard.",
            categories: [ ]
            },
            {
            id: 310,
            ...
            {
            id: 313,
            joke: "All roads lead to Chuck Norris. And by the transitive property, a roundhouse kick to the face.",
            categories: [ ]
            },
            {
            id: 314,
            ...
            {
            id: 315,
            joke: "Chuck Norris never goes to the dentist because his teeth are unbreakable. His enemies never go to the dentist because they have no teeth.",
            categories: [ ]
            },
            {
            id: 316,
            ...
            {
            id: 319,
            joke: "In the Words of Julius Caesar, &quot;Veni, Vidi, Vici, Chuck Norris&quot;. Translation: I came, I saw, and I was roundhouse-kicked inthe face by Chuck Norris.",
            categories: [ ]
            },
            {
            id: 320,
            ...
            {
            id: 322,
            joke: "When Chuck Norris plays Monopoly, it affects the actual world economy.",
            categories: [ ]
            },
            {
            id: 323,
            joke: "Chuck Norris can be unlocked on the hardest level of Tekken. But only Chuck Norris is skilled enough to unlock himself. Then he roundhouse kicks the Playstation back to Japan.",
            categories: [ ]
            },
            {
            id: 324,
            ...
            {
            id: 325,
            joke: "Every time someone uses the word &quot;intense&quot;, Chuck Norris always replies &quot;you know what else is intense?&quot; followed by a roundhouse kick to the face.",
            categories: [ ]
            },
            {
            id: 326,
            ...
            {
            id: 327,
            joke: "Chuck Norris once ordered a steak in a restaurant. The steak did what it was told.",
            categories: [ ]
            },
            {
            id: 328,
            ...
            {
            id: 330,
            joke: "President Roosevelt once rode his horse 100 miles. Chuck Norris carried his the same distance in half the time.",
            categories: [ ]
            },
            {
            id: 331,
            ...
            {
            id: 332,
            joke: "What many people dont know is Chuck Norris is the founder of planned parenthood. Not even unborn children can escape his wrath.",
            categories: [ ]
            },
            {
            id: 333,
            joke: "Chuck Norris was banned from competitive bullriding after a 1992 exhibition in San Antonio, when he rode the bull 1,346 miles from Texas to Milwaukee Wisconsin to pick up his dry cleaning.",
            categories: [ ]
            },
            {
            id: 334,
            joke: "Chuck Norris qualified with a top speed of 324 mph at the Daytona 500, without a car.",
            categories: [ ]
            },
            {
            id: 335,
            joke: "Chuck Norris likes his coffee half and half: half coffee grounds, half wood-grain alcohol.",
            categories: [ ]
            },
            {
            id: 336,
            joke: "Chuck Norris uses tabasco sauce instead of visine.",
            categories: [ ]
            },
            {
            id: 337,
            joke: "The chemical formula for the highly toxic cyanide ion is CN-. These are also Chuck Norris' initials. This is not a coincidence.",
            categories: [ ]
            },
            {
            id: 338,
            joke: "Chuck Norris' credit cards have no limit. Last weekend, he maxed them out.",
            categories: [ ]
            },
            {
            id: 339,
            ...
            {
            id: 343,
            joke: "Chuck Norris doesn't chew gum. Chuck Norris chews tin foil.",
            categories: [ ]
            },
            {
            id: 344,
            ...
            {
            id: 345,
            joke: "When in a bar, you can order a drink called a &quot;Chuck Norris&quot;. It is also known as a &quot;Bloody Mary&quot;, if your name happens to be Mary.",
            categories: [ ]
            },
            {
            id: 346,
            joke: "Every time Chuck Norris smiles, someone dies. Unless he smiles while he?s roundhouse kicking someone in the face. Then two people die.",
            categories: [ ]
            },
            {
            id: 347,
            ...
            {
            id: 349,
            joke: "A man once asked Chuck Norris if his real name is &quot;Charles&quot;. Chuck Norris did not respond, he simply stared at him until he exploded.",
            categories: [ ]
            },
            {
            id: 350,
            ...
            {
            id: 353,
            joke: "Chuck Norris is the only person who can simultaneously hold and fire FIVE Uzis: One in each hand, one in each foot -- and the 5th one he roundhouse-kicks into the air, so that it sprays bullets.",
            categories: [ ]
            },
            {
            id: 354,
            joke: "For undercover police work, Chuck Norris pins his badge underneath his shirt, directly into his chest.",
            categories: [ ]
            },
            {
            id: 355,
            joke: "In the X-Men movies, none of the X-Men super-powers are done with special effects. Chuck Norris is the stuntman for every character.",
            categories: [ ]
            },
            {
            id: 356,
            joke: "We live in an expanding universe. All of it is trying to get away from Chuck Norris.",
            categories: [ ]
            },
            {
            id: 357,
            ...
            {
            id: 358,
            joke: "The 11th commandment is ?Thou shalt not piss off Chuck Norris? This commandment is rarely enforced, as it is impossible to accomplish.",
            categories: [ ]
            },
            {
            id: 359,
            ...
            {
            id: 361,
            joke: "Who let the dogs out? Chuck Norris let the dogs out... and then roundhouse kicked them through an Oldsmobile.",
            categories: [ ]
            },
            {
            id: 362,
            ...
            {
            id: 367,
            joke: "Not everyone that Chuck Norris is mad at gets killed. Some get away. They are called astronauts.",
            categories: [ ]
            },
            {
            id: 368,
            joke: "Chuck Norris has to register every part of his body as a separate lethal weapon. His spleen is considered a concealed weapon in over 50 states.",
            categories: [ ]
            },
            {
            id: 369,
            ...
            {
            id: 370,
            joke: "Godzilla is a Japanese rendition of Chuck Norris' first visit to Tokyo.",
            categories: [ ]
            },
            {
            id: 372,
            ...
            {
            id: 374,
            joke: "Chuck Norris' sperm can be seen with the naked eye. Each one is the size of a quarter.",
            categories: [ ]
            },
            {
            id: 375,
            ...
            {
            id: 376,
            joke: "Chuck Norris doesn't daydream. He's too busy giving other people nightmares.",
            categories: [ ]
            },
            {
            id: 377,
            ...
            {
            id: 379,
            joke: "Chuck Norris' Penis is a third degree blackbelt, and an honorable 32nd-degree mason.",
            categories: [ ]
            },
            {
            id: 380,
            ...
            {
            id: 381,
            joke: "Diamonds are not, despite popular belief, carbon. They are, in fact, Chuck Norris fecal matter. This was proven a recently, when scientific analysis revealed what appeared to be Jean-Claude Van Damme bone fragments inside the Hope Diamond.",
            categories: [ ]
            },
            {
            id: 382,
            joke: "Chuck Norris once participated in the running of the bulls. He walked.",
            categories: [ ]
            },
            {
            id: 383,
            ...
            {
            id: 385,
            joke: "Chuck Norris once rode a bull, and nine months later it had a calf.",
            categories: [ ]
            },
            {
            id: 386,
            joke: "Chuck Norris once lost the remote, but maintained control of the TV by yelling at it in between bites of his &quot;Filet of Child&quot; sandwich.",
            categories: [ ]
            },
            {
            id: 387,
            ...
            {
            id: 388,
            joke: "The Manhattan Project was not intended to create nuclear weapons, it was meant to recreate the destructive power in a Chuck Norris Roundhouse Kick. They didn't even come close.",
            categories: [ ]
            },
            {
            id: 389,
            ...
            {
            id: 390,
            joke: "Divide Chuck Norris by zero and you will in fact get one........one bad-ass that is.",
            categories: [ ]
            },
            {
            id: 391,
            ...
            {
            id: 402,
            joke: "There is no such thing as a lesbian, just a woman who has never met Chuck Norris.",
            categories: [ ]
            },
            {
            id: 403,
            ...
            {
            id: 409,
            joke: "The term &quot;Cleveland Steamer&quot; got its name from Chuck Norris, when he took a dump while visiting the Rock and Roll Hall of fame and buried northern Ohio under a glacier of fecal matter.",
            categories: [ ]
            },
            {
            id: 410,
            ...
            {
            id: 413,
            joke: "Those aren't credits that roll after Walker Texas Ranger. It is actually a list of fatalities that occurred during the making of the episode.",
            categories: [ ]
            },
            {
            id: 414,
            ...
            {
            id: 417,
            joke: "According to the Bible, God created the universe in six days. Before that, Chuck Norris created God by snapping his fingers.",
            categories: [ ]
            },
            {
            id: 418,
            ...
            {
            id: 420,
            joke: "The 1972 Miami Dolphins lost one game, it was a game vs. Chuck Norris and three seven year old girls. Chuck Norris won with a roundhouse-kick to the face in overtime.",
            categories: [ ]
            },
            {
            id: 421,
            joke: "Chuck Norris is not Politically Correct. He is just Correct. Always.",
            categories: [ ]
            },
            {
            id: 422,
            ...
            {
            id: 424,
            joke: "Chuck Norris has volunteered to remain on earth after the Rapture; he will spend his time fighting the Anti-Christ.",
            categories: [ ]
            },
            {
            id: 425,
            ...
            {
            id: 426,
            joke: "A man once taunted Chuck Norris with a bag of Lay's potato chips, saying &quot;Betcha can't eat just one!&quot; Chuck Norris proceeded to eat the chips, the bag, and the man in one deft move.",
            categories: [ ]
            },
            {
            id: 427,
            ...
            {
            id: 428,
            joke: "In the first Jurassic Park movie, the Tyrannosaurus Rex wasn't chasing the jeep. Chuck Norris was chasing the Tyrannosaurus AND the jeep.",
            categories: [ ]
            },
            {
            id: 429,
            ...
            {
            id: 430,
            joke: "Chuck Norris does not wear a condom. Because there is no such thing as protection from Chuck Norris.",
            categories: [ ]
            },
            {
            id: 431,
            ...
            {
            id: 434,
            joke: "Chuck Norris wipes his ass with chain mail and sandpaper.",
            categories: [ ]
            },
            {
            id: 435,
            joke: "When you play Monopoly with Chuck Norris, you do not pass go, and you do not collect two hundred dollars. You will be lucky if you make it out alive.",
            categories: [ ]
            },
            {
            id: 436,
            joke: "Chuck Norris describes human beings as &quot;a sociable holder for blood and guts&quot;.",
            categories: [ ]
            },
            {
            id: 438,
            ...
            {
            id: 440,
            joke: "Most tough men eat nails for breakfast. Chuck Norris does all of his grocery shopping at Home Depot.",
            categories: [ ]
            },
            {
            id: 441,
            joke: "Chuck Norris did not &quot;lose&quot; his virginity, he stalked it and then destroyed it with extreme prejudice.",
            categories: [ ]
            },
            {
            id: 442,
            ...
            {
            id: 452,
            joke: "Chuck Norris can't test for equality because he has no equal.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 454,
            joke: "Chuck Norris's first program was kill -9.",
            categories: [
            "nerdy"
            ]
            },
            {
            id: 455,
            joke: "Chuck Norris burst the dot com bubble.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 465,
            joke: "Whiteboards are white because Chuck Norris scared them that way.",
            categories: [ ]
            },
            {
            id: 466,
            ...
            {
            id: 474,
            joke: "To Chuck Norris, everything contains a vulnerability.",
            categories: [
            "nerdy"
            ]
            },
            {
            id: 475,
            joke: "Chuck Norris doesn't need sudo, he just types &quot;Chuck Norris&quot; before his commands.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 477,
            joke: "Chuck Norris can access private methods.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 486,
            joke: "Chuck Norris solved the Travelling Salesman problem in O(1) time. Here's the pseudo-code: Break salesman into N pieces. Kick each piece to a different city.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 489,
            joke: "Chuck Norris can write multi-threaded applications with a single thread.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 492,
            joke: "There is no Esc key on Chuck Norris' keyboard, because no one escapes Chuck Norris.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 518,
            joke: "Chuck Norris doesn't cheat death. He wins fair and square.",
            categories: [ ]
            },
            {
            id: 519,
            ...
            {
            id: 527,
            joke: "No one has ever spoken during review of Chuck Norris' code and lived to tell about it.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 529,
            joke: "Chuck Norris doesn't use Oracle, he is the Oracle.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 531,
            joke: "Jesus can walk on water, but Chuck Norris can swim through land.",
            categories: [ ]
            },
            {
            id: 532,
            ...
            {
            id: 542,
            joke: "Chuck Norris types with one finger. He points it at the keyboard and the keyboard does the rest.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 544,
            joke: "If you try to kill -9 Chuck Norris's programs, it backfires.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 558,
            joke: "Chuck Norris never has to build his program to machine code. Machines have learnt to interpret Chuck Norris code.",
            categories: [
            "nerdy"
            ]
            },
            {
            id: 559,
            joke: "Chuck Norris' unit tests don't run. They die.",
            categories: [
            "nerdy"
            ]
            },
            {
            id: 560,
            joke: "Chuck Norris sits at the stand-up.",
            categories: [ ]
            },
            {
            id: 561,
            ...
            {
            id: 562,
            joke: "How many Chuck Norris require to screw a light bulb? None, he will screw it all.",
            categories: [ ]
            },
            {
            id: 563,
            ...
            {
            id: 567,
            joke: "Code runs faster when Chuck Norris watches it.",
            categories: [
            "nerdy"
            ]
            },
            ...
            {
            id: 587,
            joke: "Once a police officer caught Chuck Norris, the cop was lucky enough to escape with a warning.",
            categories: [ ]
            },
            {
            id: 588,
            ...
            {
            id: 590,
            joke: "Chuck Norris died before 20 years, Death doesn't have the courage to tell him yet.",
            categories: [ ]
            },
            {
            id: 591,
            ...
            {
            id: 595,
            joke: "Once Chuck Norris signed a cheque and the bank bounced.",
            categories: [ ]
            },
            {
            id: 596,
            joke: "Chuck Norris can drown a fish.",
            categories: [ ]
            },
            {
            id: 597,
            ...
            {
            id: 598,
            joke: "Once Chuck Norris and Superman had a competition. The loser had to wear his underwear over his pants.",
            categories: [ ]
            },
            {
            id: 599,
            ...
            {
            id: 600,
            joke: "Chuck Norris tears can cure the cancer, but the sad thing is Chuck Norris never cries.",
            categories: [ ]
            },
            {
            id: 601,
